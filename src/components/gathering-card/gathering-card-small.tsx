...
export default function GatheringCardSmall({
  ...
  return (
    <div
      className={`relative flex max-w-[343px] flex-col self-stretch rounded-3xl border-2 border-gray-100 transition-shadow hover:border-gray-200 hover:shadow-card-hover`}
    >
      {/* 이미지 */}
